...
public class N_Empleado {
    ...
    public int registrarDocente(String ci, String nombre, String apellido , String direccion) {
        // No olvidar primero settear los datos
        this.m_persona.setPersona(ci, nombre, apellido, direccion, correo,"Docente");
